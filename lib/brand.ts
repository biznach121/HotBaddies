...
export const brand: Brand = {
  name: "Hot Baddies Spa",
  shortName: "Hot Baddies",
  microTag: "SCRUBS, STEAM AND BADDIE MAINTENANCE",
  description:
    "Hot Baddies Spa is a Accra beauty studio where treatments, care and calm come together under one roof.",
  ...
  contact: {
    ...
    countryCode: "GH",
    phone: "0599335485",
    phoneTel: "+233599335485",
    textPhone: "0599335485",
    textPhoneTel: "+233599335485",
    email: "hello@hotbaddies.test",
    privacyEmail: "privacy@hotbaddies.test",
    hours: "Call or text to book",
  },

  socials: [
    { label: "TikTok", href: "https://www.tiktok.com/@hot_baddies_spa", icon: "tiktok" },
  ],
  ...
  hero: {
    badge: "Now booking",
    title: "stay hot,\nstay soft.\nScrubs, steam and baddie maintenance.",
    subtitle:
  ...
  editorial: {
    ...
    notes: [
      ...
      {
        body: "That is the gap Hot Baddies Spa was built for: honest treatments, fair prices, and a space that treats your time with respect.",
    ...
    images: [
      {
        ...
        alt: "Hot Baddies Spa beauty treatment detail",
      ...
      },
      {
        ...
        alt: "Hot Baddies Spa self-care treatment",
        className: "right-[5%] top-[15%] h-[255px] w-[155px] rounded-[999px]",
        sizes: "155px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Hot Baddies Spa beauty ritual",
      ...
      },
      {
        ...
        alt: "Hot Baddies Spa calm care moment",
        className: "right-[6%] top-[68%] h-[145px] w-[100px] rounded-[999px]",
        sizes: "100px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Hot Baddies Spa relaxation detail",
        className: "left-[25%] top-[75%] h-[150px] w-[102px] rounded-[999px]",
        sizes: "102px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/bgkgjrchbkhtckgh9f7t.jpg",
        alt: "Hot Baddies Spa beauty and peace detail",
    ...
    items: [
      {
        ...
        imageAlt: "Hot Baddies Spa lip gloss product",
        tone: "light",
      },
      {
        name: "mint\nbeauty oil",
        ...
        imageAlt: "Hot Baddies Spa mint oil product",
        tone: "olive",
      },
      {
        name: "brush\nessentials",
        ...
        imageAlt: "Hot Baddies Spa makeup brush set",
        tone: "light",
      },
      {
        name: "smooth\nfoundation",
        ...
        imageAlt: "Hot Baddies Spa foundation product",
        tone: "olive",
      },
    ],
  },
  ...
  media: {
    title: "media",
    ctaLabel: "Follow",
    ctaHref: "https://www.tiktok.com/@hot_baddies_spa",
    images: [
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783492665/stage4/spa_hotbaddiesspa/tiktok_0.mp4",
        alt: "Hot Baddies Spa treatment video",
        position: "center",
      },
      {
  ...
  about: {
    eyebrow: "About Hot Baddies Spa",
    title: "Your sanctuary\nof beauty and peace.",
    paragraphs: [
      "Hot Baddies Spa is a curated beauty and self-care space in Accra, created for the moments when you want to feel polished, calm, and cared for without rushing through the process.",
    ...
    sections: [
      ...
      {
        heading: "Visit",
        body: "Find us in Accra. Use the Location page for the exact Google Maps pin, or call 0599335485 and text 0599335485 for booking help.",
      },
    ],
  },
  ...
  faq: {
    ...
    sections: [
      {
        ...
        items: [
          { q: "How do I book?", a: "Use the Book page, call 0599335485, text 0599335485, or message @hot_baddies_spa on Instagram." },
          ...
          { q: "Where are you located?", a: "Hot Baddies Spa is in Accra. The Location page has the exact Google Maps pin." },
        ],
      },
      {
        title: "Treatments",
    ...
    contactEmail: "hello@hotbaddies.test",
  },
  ...
  terms: {
    ...
    sections: [
      { heading: "1. Who we are", body: "Hot Baddies Spa (\"we\", \"us\") is a beauty and self-care business in Accra, Ghana. By booking a service or buying a product, you agree to these terms." },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Your rights", body: "Under the Ghana Data Protection Act, 2012 (Act 843), you can access, correct, or delete your data. Email privacy@hotbaddies.test." },
  ...
  shipping: {
    ...
    sections: [
      ...
      { heading: "Location", body: "Hot Baddies Spa is in Accra. Visit the Location page for the exact Google Maps pin." },
  ...
  accessibility: {
    ...
    sections: [
      ...
      { heading: "Reporting issues", body: "Email accessibility@hotbaddies.test, call, or text the studio. We respond within a business day." },
    ],
  },

  account: {
    loginEyebrow: "Welcome back",
    loginTitle: "Sign in to Hot Baddies Spa",
  ...
  contactPage: {
    ...
    directLines: [
      { label: "Call", value: "0599335485", href: "tel:+233599335485" },
      { label: "Text", value: "0599335485", href: "sms:+233599335485" },
      { label: "Instagram", value: "@hot_baddies_spa", href: "https://www.tiktok.com/@hot_baddies_spa" },
    ],
  },
  ...
  footer: {
    logoUrl: "https://res.cloudinary.com/dzykdnbvb/image/upload/v1783492659/stage4/spa_hotbaddiesspa/avatar.jpg",
    blurb:
      "Hot Baddies Spa in Accra — scrubs, steam and baddie maintenance.",
    sitemap: [
      {
        title: "Visit",
        links: [
          ...
          { label: "Location", href: "/location" },
          { label: "Instagram", href: "https://www.tiktok.com/@hot_baddies_spa" },
        ],
      },
      {
        title: "Studio",
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Call 0599335485", href: "tel:+233599335485" },
          { label: "Text 0599335485", href: "sms:+233599335485" },
        ],
      },
      {
        title: "Account",
  ...
  llms: {
    summary:
      "Hot Baddies Spa — beauty and self-care in Accra. Lashes, brows, nails, pedicure, waxing, piercing, facials, massage, and beauty products. Booking via website, call, text, or Instagram.",
  },
