...
const LOGO_URL =
  "https://res.cloudinary.com/dzykdnbvb/raw/upload/v1783492658/stage4/spa_hotbaddiesspa/logo.svg";
...
export function SpaBoxLogo({ className = "", compact = false, tone = "light" }: SpaBoxLogoProps) {
  ...
  if (REAL_LOGO) {
    ...
    return (
      <span className={["relative inline-block", sizeClass, className].join(" ")} aria-label="Hot Baddies Spa - Scrubs, steam and baddie maintenance">
        <Image
          src={src}
          alt="Hot Baddies Spa - Scrubs, steam and baddie maintenance"
          fill
